...
$router->addRoute('GET','/users/activate/:id','Admin/UserController@actionActivate')->addMiddleware('GET', '/users/activate/:id', 'AuthMiddleware')
->addMiddleware('GET', '/users/activate/:id', 'AdminMiddleware');
