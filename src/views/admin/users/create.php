...
<script>
    async function register(e) {
            ...
            let registerInputElements = document.querySelectorAll("#formCreateUser input, #formCreateUser select")
            let data = {};
        ...
        document.getElementById("formCreateUser").addEventListener('submit', register);
</script>