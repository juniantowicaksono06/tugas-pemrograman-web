        ...
        <div class="col-12 connectedSortable">
            <div class="card">
                <div class="card-header">
                    <a href="/admin/borrowing-books/create" class="btn color-bg-green-1 text-white hover">Kembali</a>
                </div>
                <div class="card-body">
                        ...
                        <?php 
                            foreach($data as $book) {
                                echo "<tr>";
                                    ...
                                    $btnTitle = "Pilih Buku";
                                    if(!empty($_SESSION['dataPeminjamanBooksId'])) {
...
<script>
    $(document).ready(function() {
        ...
        async function selectBook(e) {
            ...
            try {
                showLoading()
                request.setUrl(`/admin/borrowing-books/select/${bookId}`).setMethod('POST').setData(formData);
