                ...
                <div class="card-body">
                    <form action="/admin/books" method="POST" id="formEditBook">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea name="description" id="description" class="form-control" style="resize: none;" rows="6"><?= $dataEdit['book']['description'] ?></textarea>
                            <div class="mt-2">
...
<script>
    async function edit(e) {
            ...
            let editInputElements = document.querySelectorAll("#formEditBook input, #formEditBook select, #formEditBook textarea")
            let data = {};
